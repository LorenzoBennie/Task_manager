...
# Converts the user.txt into a dictionary with usernames as keys and passwords as values
...
while True:
    ...
    # checks if the password matches the user and asks the user to try again if it does not
...
: ''').lower()
    ...
    if menu == 'r':
        ...
        # Writes the task to the task.txt file by joining the above list into a string
        ...
        with open("tasks.txt", "r") as task_file:
            ...
            # Loops through each task in tasks.txt and prints the details in the desired format
        ...
        with open("tasks.txt", "r") as task_file:
            ...
            # Loops through the current users tasks and prints the details in the desired format
            for each_line in each_task:
                task_list = each_line.split(", ")
